...
export default function BoxProcess() {
    ...
    return (
        <main className="h-auto  mt-15 max-[1018px]:pl-5 max-[1018px]:pr-5">
            <Tag label="Veja como funciona" />

            <section className="w-full h-auto  mt-10 flex max-[1018px]:flex-col">
                <article className="h-auto w-[35%] max-[1018px]:w-[100%]">
                    <h1 className="text-[60px] ">Sua tranquilidade não tem preço!</h1>
                </article>

                <article className="h-37 w-[65%] flex items-center text-Pclara max-[1018px]:h-auto max-[1018px]:w-full max-[1018px]:mt-5 max-[1018px]:mb-5">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                </article>

            </section>

            <section className=" h-auto w-full mt-10 flex max-[1018px]:flex-col">
                <figure className="h-[444px] w-[40%] max-[1018px]:w-full max-[1018px]:h-[250px]">
